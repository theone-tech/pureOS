...
lv_obj_set_style_text_color(ui_Sec, lv_color_hex(0x293062), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_text_color(ui_Date, lv_color_hex(0x293062), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_bg_color(ui_comp_get_child(ui_Scrolldots, UI_COMP_SCROLLDOTS_D1), lv_color_hex(0x293062), LV_PART_MAIN | LV_STATE_DEFAULT );
