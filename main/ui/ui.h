...
#ifndef _THEONE_PUREOS_UI_H
#define _THEONE_PUREOS_UI_H
...
#include "ui_events.h"
    ...
    void ui_event_unlockLabel(lv_event_t *e);
    extern lv_obj_t *ui_unlockLabel;
    extern lv_obj_t *ui_lockScreenTime;
    extern lv_obj_t *ui_unlockScreenDate;
    // SCREEN: ui_UnlockScreen
    void ui_UnlockScreen_screen_init(void);
    extern lv_obj_t *ui_UnlockScreen;
    void ui_event_openLabelBtn(lv_event_t *e);
    extern lv_obj_t *ui_openLabelBtn;
    extern lv_obj_t *ui_Label5;
    extern lv_obj_t *ui_codeOne;
    extern lv_obj_t *ui_codeTwo;
    extern lv_obj_t *ui_codeThree;
    extern lv_obj_t *ui_codeFour;
    // SCREEN: ui_HomeScreen
    void ui_HomeScreen_screen_init(void);
    extern lv_obj_t *ui_HomeScreen;
    // SCREEN: ui_AppsScreen
    void ui_AppsScreen_screen_init(void);
    extern lv_obj_t *ui_AppsScreen;
    // SCREEN: ui_PhoneApp
    void ui_PhoneApp_screen_init(void);
    extern lv_obj_t *ui_PhoneApp;
    extern lv_obj_t *ui____initial_actions0;

    LV_IMG_DECLARE(ui_img_515798598); // assets/Screenshot 2023-07-18 at 15.38.11.png
