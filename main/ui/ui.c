...
lv_obj_t *ui_unlockLabel;
lv_obj_t *ui_lockScreenTime;
lv_obj_t *ui_unlockScreenDate;
...
lv_obj_t *ui_openLabelBtn;
lv_obj_t *ui_Label5;
lv_obj_t *ui_codeOne;
lv_obj_t *ui_codeTwo;
lv_obj_t *ui_codeThree;
lv_obj_t *ui_codeFour;
...
lv_obj_t *ui_AppsScreen;

// SCREEN: ui_PhoneApp
void ui_PhoneApp_screen_init(void);
lv_obj_t *ui_PhoneApp;
lv_obj_t *ui____initial_actions0;
const lv_img_dsc_t *ui_imgset_499531011[1] = {&ui_img_515798598};
...
void ui_event_unlockLabel(lv_event_t *e)
{
    ...
    {
        // _ui_screen_change(&ui_UnlockScreen, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_UnlockScreen_screen_init);
    }
}
void ui_event_openLabelBtn(lv_event_t *e)
{
...
void ui_init(lv_disp_t *dispp)
{
      ...
      // lv_theme_t *theme1 = lv_theme_default_init(dispp, lv_palette_main(LV_PALETTE_BLUE), lv_palette_main(LV_PALETTE_RED), true, LV_FONT_DEFAULT);
      ...
      ui_AppsScreen_screen_init();
      ui_PhoneApp_screen_init();
